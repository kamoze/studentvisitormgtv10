odoo.define('visitor_barcode.greeting_message', function (require) {
"use strict";
...
var GreetingMessage = Widget.extend(BarcodeHandlerMixin, {
    template: 'VisitorGreetingMessage',
    ...
    init: function(parent, action) {
        ...
        if (this.attendance.in_datetime){
            console.log(this.attendance.in_datetime)
            this.attendance.check_in = this.attendance.in_datetime && moment.utc(this.attendance.in_datetime).local();
            this.attendance.check_out = this.attendance.out_datetime && moment.utc(this.attendance.out_datetime).local();
    ...
    welcome_message: function() {
        ...
        self.next_action = 'visitor_barcode.event_barcode_action_main_view_id';
...
core.action_registry.add('visitor_greeting_message', GreetingMessage);
